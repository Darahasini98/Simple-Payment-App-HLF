...
async function GetAllAccounts(userName) {
    ...
    let response;
     ...
     try {
        ...
        console.log('Use simple payment  smart contract.');
        ...
        // addPart
        console.log('Submit Getallaccounts transaction.');

        // const crt = await fabricNetwork.connectNetwork(connection,WalletOrg)

        const addResponse = await contract.submitTransaction('GetAllAccounts');

        // process response
        console.log(' transaction response.'+addResponse);

        let accounts = addResponse.toString();

        console.log(`Part ${accounts} was added successfully`);
        console.log('Transaction complete.');
        response = { success: true, message: ` ${accounts} was addded  `};
