...
async function main() {
	try {
		...
		try {
			...
			// result = await contract.submitTransaction('RegisterUserAccount', '5', 'Gani', 'SBI', '20000.0', 'false');
			...
			// result = await contract.evaluateTransaction('ReadAccount', '1');
			// console.log(`*** Result: ${prettyJSONString(result.toString())}`);
			...
			// await contract.submitTransaction('Transfer', '1', '2','200');
			// console.log('*** Result: committed');
